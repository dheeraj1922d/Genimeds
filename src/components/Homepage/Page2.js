...
const page2 = () => {
  return (
    <div>
      <div className=" flex flex-col  items-center relative px-[150px] pb-10">
        <div className="flex flex-col items-center relative">
         

          <div className="stroke-orange"></div>
          <div className=" top-[150px] flex flex-col w-[80px] h-[80px] items-center justify-center  bg-amber-500 rounded-[100px] mb-4">
        ...
        <div className="relative flex justify-between gap-2 mb-[200px]">
          <span className="decoration-orange">Regulated </span>
          <h2 className="top_text "> By Health Authorities </h2>
