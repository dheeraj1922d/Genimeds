  ...
  return (
    <div>
      ...
      <div className="flex-col w-[496px] items-center px-[20px] py-[10px] bg-white shadow-[0px_2px_25px_#0000001f] flex gap-[20px] relative self-stretch">
        <img className="relative w-[250px] h-[250px] object-cover" alt="Download" src="download-1.png" />
        ...
        <p className="relative self-stretch [font-family:'Inter-Bold',Helvetica] font-normal text-transparent text-[20px] tracking-[0] leading-[30px]">
          ...
          <span className="[font-family:'Inter-Light',Helvetica] font-light text-zinc-500">
            <br />
            On chest and throat, temporarily relieves cough due to minor throat and bronchial irritation associated with
            the common cold
            <br />
        ...
        <p className="relative self-stretch [font-family:'Inter-Bold',Helvetica] font-normal text-transparent text-[20px] tracking-[0] leading-[30px]">
          ...
          <span className="[font-family:'Inter-Light',Helvetica] font-light text-zinc-500">
            <br />
            Regular: Camphor (synthetic) 4.8% (Cough suppressant and topical analgesic) Eucalyptus oil 1.2% (Cough
            suppressant) Menthol 2.6% (Cough suppressant and topical analgesic)
            <br />
            Lemon: Camphor (synthetic) 4.7% (Cough suppressant and topical analgesic) Eucalyptus oil 1.2% (Cough
            suppressant) Menthol 2.6% (Cough suppressant and topical analgesic).
          </span>
        </p>
      </div>
